...
![Contrast checker with failed 2.58:1 results on original template colors](/assets/images/accessibility-letting-go-gold/gold-contrast-check-fail.png)
...
![Contrast checker with passing 4.58:1 results but not gold](/assets/images/accessibility-letting-go-gold/gold-contrast-check-pass.png)
...
|:------:|:-----:|
| ![Template with light theme and gold accent](/assets/images/accessibility-letting-go-gold/template-before-light-gold.png) | ![Template with light theme, monochrome](/assets/images/accessibility-letting-go-gold/template-after-light-no-gold.png) |

| Before (Dark) | After (Dark) |
|:------:|:-----:|
| ![Template with dark theme and gold accent](/assets/images/accessibility-letting-go-gold/template-before-dark-gold.png) | ![Template with dark theme, monochrome](/assets/images/accessibility-letting-go-gold/template-after-dark-no-gold.png) |
