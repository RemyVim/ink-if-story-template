...
title: Quick Start
description: >-
  Get your Ink story running in minutes with this web template for interactive
  fiction.
---
# Quick Start Guide
...
Note: The `title` and `author` both appear in the navigation bar.
...
- Verify audio files are in `build/assets/` folder or wherever you put them in your ink source
